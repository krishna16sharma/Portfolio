...
function App() {
    ...
    const Sky = ParallaxJSXWrapper(
        <div>
        <img src="./images/background.png" alt="" className="sky"/>
        </div>
        , 0.05);
    ...
    const Moon = ParallaxJSXWrapper(<img src="./images/Moon.png" alt="" className="moon"/>, 0.02);
        ...
        <div className="section2">
            ...
            <div className="section2_container">
                ...
                <div className="right_side">
                    <img src="./images/Photo_Circle.jpg" className="image" alt=""/>
            ...
            <div className="project-grid-container">
              <div className="project-grid-item">
                <div className="content">
                    <img src="./images/covid.jpg" alt="Covid-19 Dashboard" style={{width:"500px",height:"300px"}}/>
                    <a href={'https://github.com/krishna16sharma/Covid19_Dashboard'}>
                        <div class="overlay">
                            <div class="text">A website built using React.js and deployed at Heroku which helps users get important statistics about Covid-19 cases in India.</div>
                        </div>
                    </a>
                </div>
                <span className="project_captions">Covid-19 Dashboard</span>
              </div>
              <div className="project-grid-item">
                    <div className="content">
                        <img src="./images/House.webp" alt="Predict house Prices" style={{width:"500px",height:"300px"}}/>
              ...
              <div className="project-grid-item">
                    <div className="content">
                        <img src="./images/Teacher.png" alt="Profile Builder" style={{width:"500px",height:"300px"}}/>
              ...
              <div className="project-grid-item">
                    <div className="content">
                        <img src="./images/Campus.jpg" alt="Campus Recruitment" style={{width:"500px",height:"300px"}}/>
                        <a href={'https://github.com/krishna16sharma/Campus-Recruitment'}>
                            <div class="overlay">
                                <div class="text">
                                    A case study where several classification models were used on the dataset and compared to see which worked the best.
                                </div>
                            </div>
                        </a>
                    </div>
                <span className="project_captions">Campus Recruitment</span>
              </div>
            </div>
        </div>, 0.05)
